...
if original_image is None:
    ...
    if len(original_image.shape) == 2:
        save_histogram(original_image, "Original Image Histogram", "histogramoriginal.png", color_mode="gray")
    else:
        save_histogram(original_image, "Original Image Histogram", "histogramoriginal.png", color_mode="color")
...
print("[✔] Histogram analysis completed. Saved as 'histogramoriginal.png' and 'histogramencrypted.png'.")
